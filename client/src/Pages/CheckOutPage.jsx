...
const CheckOutPage = () => {
  ...
  const fetchCart = async () => {
    ...
    try {
      const token = localStorage.getItem("customerToken");
      const response = await fetch(`https://suyambufoodproducts-demohost-4.onrender.com/api/customer/cart?customerId=${customerId}`, {
        headers: {
          "Content-Type": "application/json",
          Origin: "http://localhost:5173",
          Authorization: `Bearer ${token}`,
  ...
  const updateQuantity = async (variantId, change) => {
    ...
    try {
      const token = localStorage.getItem("customerToken");
      const response = await fetch(`https://suyambufoodproducts-demohost-4.onrender.com/api/customer/cart`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
          Origin: "http://localhost:5173",
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      const token = localStorage.getItem("customerToken");
      const response = await fetch(`https://suyambufoodproducts-demohost-4.onrender.com/api/customer/orders`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
          Authorization: `Bearer ${token}`,
